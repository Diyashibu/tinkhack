...
const HabitTracker = () => {
    ...
    <Box sx={{ mb: 3 }}>
      ...
      <FormControl fullWidth>
        <Select
          ...
          startAdornment={
            <Box sx={{ color: '#00a884', mr: 2, display: 'flex', alignItems: 'center' }}>
              {icon}
            </Box>
          }
        >
  ...
  return (
    <Container maxWidth="sm" sx={{ minHeight: '100vh', display: 'flex', justifyContent: 'center', alignItems: 'center', p: 2, bgcolor: '#f5faf8' }}>
      <Paper 
        elevation={6} 
        sx={{ 
          width: '100%', 
        ...
        <Box sx={{ p: 3 }}>
          ...
          <Box sx={{ mb: 3 }}>
            ...
            <Slider
              ...
              sx={{
                ...
                '& .MuiSlider-thumb': {
                  ...
                  height: 16,
                  '&:before': {
                    boxShadow: '0 0 0 8px rgba(0, 168, 132, 0.1)',
                  },
            ...
            <Box sx={{ display: 'flex', justifyContent: 'space-between', mt: 1 }}>
              <LocalDrinkIcon sx={{ color: '#00a884', fontSize: '1rem' }} />
              <LocalDrinkIcon sx={{ color: '#00a884', fontSize: '1rem' }} />
            </Box>
          </Box>
